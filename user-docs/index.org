...
* Documentation
 ...
 #+BEGIN_HTML
 <p>
 <a href="../ovpl-kit/user-docs/index.org" target="_blank">Documentation on OVPL KIT (opens in another tab)</a> 
 </p>
 #+END_HTML

 #+BEGIN_HTML
 <p>
 <a href="../ui-1.0-toolkit/user-docs/index.org" target="_blank">Documentation on UI KIT (opens in another tab)</a> 
 </p>
 #+END_HTML
