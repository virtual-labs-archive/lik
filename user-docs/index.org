...
* Documentation
  ...
  Documentation for both OVPL Kit and UI KIT is
  here:


[[../ovpl-kit/user-docs/setup-centos.html][Documentation of OVPL KIT]] 

[[../ui-1.0-toolkit/user-docs/index.html][Documentation of UI KIT]]
